...
export function GameItemJsx({ game = { id: 0, name: "サンプルゲーム", image: "/placeholder.svg?height=50&width=50", players: "2-4人", isWanted: false }, onToggle = () => {} }) {
  return <GameItem game={game} onToggle={onToggle} />;
}